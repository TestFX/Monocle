...
```gradle
testCompile "org.testfx:openjfx-monocle:jdk-17.0.0+15" // For Java 17
...
<dependency>
    ...
    <version>jdk-17.0.0+15</version> <!-- 12.0.1+2 for Java 12, jdk-11+26 for Java 11, jdk-9+181 for Java 9, 8u76-b04 for Java 8 -->
    <scope>test</scope>
</dependency>
```
